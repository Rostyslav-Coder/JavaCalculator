...
class ButtonClickListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            switch (command) {
                ...
                case Button.SQ -> {
                    ...
                    calculatorGUI.addToHistory(
                        formatResult(operand_1) + " ^ 2 = " + formatResult(result)
                    );
                }
                case Button.SQRT -> {
                    operand_1 = Double.parseDouble(display.getText());
                ...
                case Button.INV -> {
                    ...
                    if (operand_1 == 0) {
                        ...
                        display.setText(String.valueOf(formatResult(result)));
                        calculatorGUI.addToHistory(
                            "1 / " + formatResult(operand_1) + " = " + formatResult(result)
                        );
                    }
                }
                case Button.SIGN -> {
                ...
                case Button.EQ -> {
                    ...
                    display.setText(String.valueOf(formatResult(result)));
                    calculatorGUI.addToHistory(
                        formatResult(operand_1) +
                        " " + operator + " " +
                        formatResult(operand_2) +
                        " = " + formatResult(result)
                    );
                    operator = "";
                }
            ...
            display.setText("Illegal State Error");
            System.err.println("Illegal State Error: " + ex.getMessage());
        } catch (Exception ex) {
